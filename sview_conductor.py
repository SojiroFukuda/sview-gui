...
class MyForm(Qw.QMainWindow):
    ...
    def initUI(self):
        ...
        self.ui.logbox.document().setDefaultStyleSheet(pygments.formatters.HtmlFormatter(style=MyForm.STYLE).get_style_defs('.highlight'))
    ...
    def setPlotType(self):
        ...
        if self.PLOT_TYPE == MyForm.HISTGRAM: #Histogram
            ...
            # for i,item in enumerate(self.NUMERIC_HEADER_LIST):
                # self.ui.cmb_x.addItem(item)
                # self.ui.cmb_y.addItem(item)
        elif self.PLOT_TYPE == MyForm.DENSITY:
            # self.ui.cmb_x.clear()
            # self.ui.cmb_y.clear()
            # self.ui.cmb_x.setEnabled(True)
            self.ui.cmb_y.setEnabled(True)
            # for i,item in enumerate(self.NUMERIC_HEADER_LIST):
                # self.ui.cmb_x.addItem(item)
                # self.ui.cmb_y.addItem(item)
        elif self.PLOT_TYPE == MyForm.LINE:
            # self.ui.cmb_x.clear()
            # self.ui.cmb_y.clear()
            # self.ui.cmb_x.setEnabled(True)
            self.ui.cmb_y.setEnabled(True)
            # for i,item in enumerate(self.NUMERIC_HEADER_LIST):
                # self.ui.cmb_x.addItem(item)
                # self.ui.cmb_y.addItem(item)
        elif self.PLOT_TYPE == MyForm.BOXPLOT:
            # self.ui.cmb_x.clear()
            # self.ui.cmb_y.clear()
            # self.ui.cmb_x.setEnabled(True)
            self.ui.cmb_y.setEnabled(True)
